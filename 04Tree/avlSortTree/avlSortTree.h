...
#define LH_AVL_SORT_TREE 1 //左边高
#define EH_AVL_SORT_TREE 0 //左右等高
#define RH_AVL_SORT_TREE -1 //右边高
...
typedef BinarySortTreeNode AVLSortTreeNode;
//平衡二叉树(!!!!!平衡二叉树本质上是一棵特殊的二叉排序树)
typedef BinarySortTree AVLSortTree;
